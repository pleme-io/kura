...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "git+https://github.com/pleme-io/egaku-term#0.2.1" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "aa3fd63402577c624df499e5e3798d313e4fe6cd";
          sha256 = "02hjvz74nra29ldpyvf7kn8a4g77fzn2wzjqq0hmghbwmmrj5yac";
        };
        libName = "egaku_term";
        dependencies = [
          {
      ...
      "git+https://github.com/pleme-io/egaku-term?tag=v0.2.1#0.2.1" = rec {
        crateName = "egaku-term";
        version = "0.2.1";
        edition = "2024";
        workspace_member = null;
      ...
      "ishou-tokens" = rec {
        ...
        dependencies = [
          {
            name = "irodori";
            packageId = "registry+https://github.com/rust-lang/crates.io-index#irodori@0.1.0";
          }
          {
            name = "serde";
            packageId = "serde";
      ...
      "kura" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./kura; };
        authors = [
      ...
      "kura-check" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./kura-check; };
        authors = [
          "Pleme.io <engineering@pleme.io>"
        ];
        dependencies = [
      ...
      "kura-run" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./kura-run; };
        libName = "kura_run";
        authors = [
          "Pleme.io <engineering@pleme.io>"
        ];
      ...
      "moldura" = rec {
        ...
        workspace_member = null;
        src = pkgs.fetchgit {
          url = "https://github.com/pleme-io/moldura";
          rev = "abea4c69c698e5972e10f5fb9478ff3ce7f8a5a4";
          sha256 = "1b68gc62rhm2whhfbfqf5kig3036mfn88g5xlw35h9j7w04mdfyn";
        };
        authors = [
          "pleme-io"
        ];
      ...
      "pastey" = rec {
        ...
        version = "0.2.2";
        edition = "2018";
        sha256 = "0alq9j866cji66ls6c8wi4i6rv1867y7habl2lfhgpvvw3q9g9y5";
        procMacro = true;
        authors = [
      ...
      "registry+https://github.com/rust-lang/crates.io-index#irodori@0.1.0" = rec {
        crateName = "irodori";
        version = "0.1.0";
        edition = "2024";
      ...
      "rustix 1.1.4" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "default" "event" "fs" "net" "std" "system" ];
      };
      "rustls" = rec {
        crateName = "rustls";
        version = "0.23.39";
